...
% Author's metadata
\author{Adil Zhetigenov} % Update with actual author name
\degree{Computer Science BSc} % Update with actual degree if different

% Superivsor(s)' metadata
\supervisor{Porkolab Zoltan} % internal supervisor's name
...
\department{DDepartment of Programming Languages and Compilers} % department's name
\city{Budapest} % city
